...
int main()
{
    ...
    double I_limit = 2.;
    double total_load = 2.;
    double penalty_price_voltage = std::numeric_limits<double>::infinity();

    ADMM::opf_structs opfs;
    radial_line_problem_split_set(opfs, num_node, num_price, y_l, theta_limit, I_limit, total_load, penalty_price_voltage);
